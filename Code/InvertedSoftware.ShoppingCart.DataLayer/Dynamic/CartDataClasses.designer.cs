...
namespace InvertedSoftware.ShoppingCart.DataLayer.Dynamic
{
	...
	public partial class Customer : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<GiftRegistry> _GiftRegistries;
    ...
    partial void OnActiveChanged();
		...
		public Customer()
		{
			...
			this._GiftRegistries = new EntitySet<GiftRegistry>(new Action<GiftRegistry>(this.attach_GiftRegistries), new Action<GiftRegistry>(this.detach_GiftRegistries));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Customer_GiftRegistry", Storage="_GiftRegistries", ThisKey="CustomerID", OtherKey="CustomerID")]
		public EntitySet<GiftRegistry> GiftRegistries
		{
			get
			{
				return this._GiftRegistries;
			}
			set
			{
				this._GiftRegistries.Assign(value);
			}
		}
		...
		private void attach_GiftRegistries(GiftRegistry entity)
		{
			this.SendPropertyChanging();
			entity.Customer = this;
		}
		
		private void detach_GiftRegistries(GiftRegistry entity)
		{
			this.SendPropertyChanging();
			entity.Customer = null;
		}
	...
	public partial class GiftRegistry : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<GiftRegistryProduct> _GiftRegistryProducts;
    ...
    partial void OnActiveChanged();
		...
		public GiftRegistry()
		{
			this._GiftRegistryProducts = new EntitySet<GiftRegistryProduct>(new Action<GiftRegistryProduct>(this.attach_GiftRegistryProducts), new Action<GiftRegistryProduct>(this.detach_GiftRegistryProducts));
			this._Customer = default(EntityRef<Customer>);
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GiftRegistryID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int GiftRegistryID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="GiftRegistry_GiftRegistryProduct", Storage="_GiftRegistryProducts", ThisKey="GiftRegistryID", OtherKey="GiftRegistryID")]
		public EntitySet<GiftRegistryProduct> GiftRegistryProducts
		{
			get
			{
				return this._GiftRegistryProducts;
			}
			set
			{
				this._GiftRegistryProducts.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Customer_GiftRegistry", Storage="_Customer", ThisKey="CustomerID", OtherKey="CustomerID", IsForeignKey=true)]
		public Customer Customer
		{
			get
			{
			...
			set
			{
							...
							|| (this._Customer.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Customer.Entity = null;
						previousValue.GiftRegistries.Remove(this);
					}
					this._Customer.Entity = value;
					if ((value != null))
					{
						value.GiftRegistries.Add(this);
						this._CustomerID = value.CustomerID;
					}
					else
					{
		...
		private void attach_GiftRegistryProducts(GiftRegistryProduct entity)
		{
			this.SendPropertyChanging();
			entity.GiftRegistry = this;
		}
		
		private void detach_GiftRegistryProducts(GiftRegistryProduct entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnProductLinkChanging(string value);
    ...
    partial void OnActiveChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ProductLink", DbType="VarChar(400)")]
		public string ProductLink
		{
			...
			set
			{
				if ((this._ProductLink != value))
				{
					this.OnProductLinkChanging(value);
					this.SendPropertyChanging();
					this._ProductLink = value;
					this.SendPropertyChanged("ProductLink");
					this.OnProductLinkChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_GiftRegistryProduct", Storage="_GiftRegistryProducts", ThisKey="ProductID", OtherKey="ProductID")]
		public EntitySet<GiftRegistryProduct> GiftRegistryProducts
		{
			get
			{
    ...
    partial void OnAmountChanged();
    partial void OnIsAfterShippingChanging(bool value);
    partial void OnIsAfterShippingChanged();
    partial void OnCountryIDChanging(int value);
    partial void OnCountryIDChanged();
    partial void OnStateIDChanging(System.Nullable<int> value);
    partial void OnStateIDChanged();
    ...
    partial void OnActiveChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IsAfterShipping", DbType="Bit NOT NULL")]
		public bool IsAfterShipping
		{
			get
			{
				return this._IsAfterShipping;
			}
			set
			{
				if ((this._IsAfterShipping != value))
				{
					this.OnIsAfterShippingChanging(value);
					this.SendPropertyChanging();
					this._IsAfterShipping = value;
					this.SendPropertyChanged("IsAfterShipping");
					this.OnIsAfterShippingChanged();
				}
			}
		}
