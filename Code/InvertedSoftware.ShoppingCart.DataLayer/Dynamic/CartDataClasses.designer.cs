...
namespace InvertedSoftware.ShoppingCart.DataLayer.Dynamic
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="InvertedSoftwareCart")]
    ...
    partial void OnActiveChanged();
		...
		[Association(Name="Category_FeaturedProduct", Storage="_FeaturedProducts", ThisKey="CategoryID", OtherKey="CategoryID")]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_TaxName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Fixed", DbType="Bit NOT NULL")]
		public bool Fixed
		{
			get
			{
		...
		[Column(Storage="_Amount", DbType="Decimal(18,3)")]
		...
		[Association(Name="Country_Tax", Storage="_Country", ThisKey="CountryID", OtherKey="CountryID", IsForeignKey=true)]
		...
		[Association(Name="Province_Tax", Storage="_Province", ThisKey="ProvinceID", OtherKey="ProvinceID", IsForeignKey=true)]
		...
		[Association(Name="State_Tax", Storage="_State", ThisKey="StateID", OtherKey="StateID", IsForeignKey=true)]
		public State State
		{
			get
			{
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_CountryName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_CountryCode", DbType="VarChar(2) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Country_Tax", Storage="_Taxes", ThisKey="CountryID", OtherKey="CountryID")]
		...
		[Association(Name="Country_Order", Storage="_Orders", ThisKey="CountryID", OtherKey="CountryID")]
		...
		[Association(Name="Country_Shipping", Storage="_Shippings", ThisKey="CountryID", OtherKey="CountryID")]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_MemberID", DbType="UniqueIdentifier NOT NULL")]
		...
		[Column(Storage="_DayPhone", DbType="VarChar(50)")]
		...
		[Column(Storage="_EveningPhone", DbType="VarChar(50)")]
		...
		[Association(Name="Province_Customer", Storage="_Province", ThisKey="ProvinceID", OtherKey="ProvinceID", IsForeignKey=true)]
		public Province Province
		{
			get
			{
		...
		[Association(Name="State_Customer", Storage="_State", ThisKey="StateID", OtherKey="StateID", IsForeignKey=true)]
		public State State
		{
			get
			{
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_CustomFieldID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_CustomFieldName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_CustomFieldTypeID", DbType="Int NOT NULL")]
		...
		[Association(Name="CustomField_OrderProductCustomField", Storage="_OrderProductCustomFields", ThisKey="CustomFieldID", OtherKey="CustomFieldID")]
		...
		[Association(Name="CustomFieldType_CustomField", Storage="_CustomFieldType", ThisKey="CustomFieldTypeID", OtherKey="CustomFieldTypeID", IsForeignKey=true)]
		...
		[Association(Name="Product_CustomField", Storage="_Product", ThisKey="ProductID", OtherKey="ProductID", IsForeignKey=true)]
	...
	[Table(Name="dbo.CustomFieldType")]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_CustomFieldTypeID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int CustomFieldTypeID
		{
			get
			{
		...
		[Column(Storage="_CustomFieldTypeName", DbType="VarChar(50)")]
		...
		[Association(Name="CustomFieldType_CustomField", Storage="_CustomFields", ThisKey="CustomFieldTypeID", OtherKey="CustomFieldTypeID")]
	...
	[Table(Name="dbo.FeaturedProduct")]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_FeaturedProductID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="Category_FeaturedProduct", Storage="_Category", ThisKey="CategoryID", OtherKey="CategoryID", IsForeignKey=true)]
		...
		[Association(Name="Product_FeaturedProduct", Storage="_Product", ThisKey="ProductID", OtherKey="ProductID", IsForeignKey=true)]
		public Product Product
		{
			get
			{
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_ImageName", DbType="VarChar(200)")]
		...
		[Column(Storage="_ImageURL", DbType="VarChar(200) NOT NULL", CanBeNull=false)]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_OrderNumber", DbType="VarChar(50)")]
		...
		[Column(Storage="_ShippingProviderID", DbType="Int")]
		...
		[Column(Storage="_ShippingNumber", DbType="VarChar(50)")]
		...
		[Column(Storage="_Comments", DbType="VarChar(400)")]
		...
		[Column(Storage="_DatePlaced", DbType="DateTime")]
		...
		[Association(Name="Order_OrderProduct", Storage="_OrderProducts", ThisKey="OrderID", OtherKey="OrderID")]
		...
		[Association(Name="Country_Order", Storage="_Country", ThisKey="CountryID", OtherKey="CountryID", IsForeignKey=true)]
		public Country Country
		{
			get
			{
		...
		[Association(Name="Province_Order", Storage="_Province", ThisKey="ProvinceID", OtherKey="ProvinceID", IsForeignKey=true)]
		public Province Province
		{
			get
			{
		...
		[Association(Name="ShippingProvider_Order", Storage="_ShippingProvider", ThisKey="ShippingProviderID", OtherKey="ShippingProviderID", IsForeignKey=true)]
		...
		[Association(Name="State_Order", Storage="_State", ThisKey="StateID", OtherKey="StateID", IsForeignKey=true)]
		public State State
		{
			get
			{
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_OrderProductID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_PricePerUnit", DbType="Money NOT NULL")]
		...
		[Column(Storage="_TotalPrice", DbType="Money NOT NULL")]
		...
		[Association(Name="OrderProduct_OrderProductCustomField", Storage="_OrderProductCustomFields", ThisKey="OrderProductID", OtherKey="OrderProductID")]
		public EntitySet<OrderProductCustomField> OrderProductCustomFields
		{
			get
			{
		...
		[Association(Name="OrderProduct_OrderProductOption", Storage="_OrderProductOptions", ThisKey="OrderProductID", OtherKey="OrderProductID")]
		...
		[Association(Name="Order_OrderProduct", Storage="_Order", ThisKey="OrderID", OtherKey="OrderID", IsForeignKey=true)]
		public Order Order
		{
			get
			{
		...
		[Association(Name="Product_OrderProduct", Storage="_Product", ThisKey="ProductID", OtherKey="ProductID", IsForeignKey=true)]
		public Product Product
		{
			get
			{
	...
	[Table(Name="dbo.OrderProductCustomField")]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_OrderProductCustomFieldID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_OrderProductID", DbType="Int NOT NULL")]
		public int OrderProductID
		{
			get
			{
		...
		[Column(Storage="_CustomFieldID", DbType="Int NOT NULL")]
		public int CustomFieldID
		{
			get
			{
		...
		[Column(Storage="_OrderProductCustomFieldValue", DbType="VarChar(400)")]
		...
		[Association(Name="CustomField_OrderProductCustomField", Storage="_CustomField", ThisKey="CustomFieldID", OtherKey="CustomFieldID", IsForeignKey=true)]
		...
		[Association(Name="OrderProduct_OrderProductCustomField", Storage="_OrderProduct", ThisKey="OrderProductID", OtherKey="OrderProductID", IsForeignKey=true)]
	...
	[Table(Name="dbo.OrderProductOption")]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_OrderProductOptionID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_ProductOptionID", DbType="Int NOT NULL")]
		...
		[Association(Name="OrderProduct_OrderProductOption", Storage="_OrderProduct", ThisKey="OrderProductID", OtherKey="OrderProductID", IsForeignKey=true)]
		public OrderProduct OrderProduct
		{
			get
			{
		...
		[Association(Name="ProductOption_OrderProductOption", Storage="_ProductOption", ThisKey="ProductOptionID", OtherKey="ProductOptionID", IsForeignKey=true)]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_OrderStatusName", DbType="VarChar(50)")]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_CatalogNumber", DbType="VarChar(50)")]
		...
		[Association(Name="Product_CustomField", Storage="_CustomFields", ThisKey="ProductID", OtherKey="ProductID")]
		public EntitySet<CustomField> CustomFields
		{
			get
			{
		...
		[Association(Name="Product_FeaturedProduct", Storage="_FeaturedProducts", ThisKey="ProductID", OtherKey="ProductID")]
		public EntitySet<FeaturedProduct> FeaturedProducts
		{
			get
			{
		...
		[Association(Name="Product_OrderProduct", Storage="_OrderProducts", ThisKey="ProductID", OtherKey="ProductID")]
		public EntitySet<OrderProduct> OrderProducts
		{
			get
			{
		...
		[Association(Name="Product_ProductOption", Storage="_ProductOptions", ThisKey="ProductID", OtherKey="ProductID")]
		...
		[Association(Name="Product_RelatedProduct", Storage="_RelatedProducts", ThisKey="ProductID", OtherKey="ProductOneID")]
		...
		[Association(Name="Product_RelatedProduct1", Storage="_RelatedProducts1", ThisKey="ProductID", OtherKey="ProductTwoID")]
		...
		[Association(Name="Product_Shipping", Storage="_Shippings", ThisKey="ProductID", OtherKey="ProductID")]
		public EntitySet<Shipping> Shippings
		{
			get
			{
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_ProductOptionID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ProductOptionID
		{
			get
			{
		...
		[Column(Storage="_ProductOptionName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ProductOptionGroup", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_PriceChange", DbType="Money NOT NULL")]
		...
		[Association(Name="ProductOption_OrderProductOption", Storage="_OrderProductOptions", ThisKey="ProductOptionID", OtherKey="ProductOptionID")]
		public EntitySet<OrderProductOption> OrderProductOptions
		{
			get
			{
		...
		[Association(Name="Product_ProductOption", Storage="_Product", ThisKey="ProductID", OtherKey="ProductID", IsForeignKey=true)]
		public Product Product
		{
			get
			{
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_ProvinceID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_ProvinceName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ProvinceCode", DbType="VarChar(2) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Active", DbType="Char(10) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Province_Tax", Storage="_Taxes", ThisKey="ProvinceID", OtherKey="ProvinceID")]
		public EntitySet<Tax> Taxes
		{
			get
			{
		...
		[Association(Name="Province_Customer", Storage="_Customers", ThisKey="ProvinceID", OtherKey="ProvinceID")]
		public EntitySet<Customer> Customers
		{
			get
			{
		...
		[Association(Name="Province_Order", Storage="_Orders", ThisKey="ProvinceID", OtherKey="ProvinceID")]
		public EntitySet<Order> Orders
		{
			get
			{
		...
		[Association(Name="Province_Shipping", Storage="_Shippings", ThisKey="ProvinceID", OtherKey="ProvinceID")]
		public EntitySet<Shipping> Shippings
		{
			get
			{
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_RelatedProductID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_ProductOneID", DbType="Int NOT NULL")]
		...
		[Column(Storage="_ProductTwoID", DbType="Int NOT NULL")]
		...
		[Association(Name="Product_RelatedProduct", Storage="_Product", ThisKey="ProductOneID", OtherKey="ProductID", IsForeignKey=true)]
		public Product Product
		{
			get
			{
		...
		[Association(Name="Product_RelatedProduct1", Storage="_Product1", ThisKey="ProductTwoID", OtherKey="ProductID", IsForeignKey=true)]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_ShippingID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_ShippingProviderID", DbType="Int NOT NULL")]
		...
		[Association(Name="Country_Shipping", Storage="_Country", ThisKey="CountryID", OtherKey="CountryID", IsForeignKey=true)]
		public Country Country
		{
			get
			{
		...
		[Association(Name="Product_Shipping", Storage="_Product", ThisKey="ProductID", OtherKey="ProductID", IsForeignKey=true)]
		public Product Product
		{
			get
			{
		...
		[Association(Name="Province_Shipping", Storage="_Province", ThisKey="ProvinceID", OtherKey="ProvinceID", IsForeignKey=true)]
		public Province Province
		{
			get
			{
		...
		[Association(Name="ShippingProvider_Shipping", Storage="_ShippingProvider", ThisKey="ShippingProviderID", OtherKey="ShippingProviderID", IsForeignKey=true)]
		public ShippingProvider ShippingProvider
		{
			get
			{
		...
		[Association(Name="State_Shipping", Storage="_State", ThisKey="StateID", OtherKey="StateID", IsForeignKey=true)]
		public State State
		{
			get
			{
	...
	[Table(Name="dbo.ShippingProvider")]
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_ShippingProviderID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ShippingProviderID
		{
			get
			{
		...
		[Column(Storage="_ShippingProviderName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ShippingCost", DbType="Money NOT NULL")]
		...
		[Association(Name="ShippingProvider_Order", Storage="_Orders", ThisKey="ShippingProviderID", OtherKey="ShippingProviderID")]
		public EntitySet<Order> Orders
		{
			get
			{
		...
		[Association(Name="ShippingProvider_Shipping", Storage="_Shippings", ThisKey="ShippingProviderID", OtherKey="ShippingProviderID")]
		public EntitySet<Shipping> Shippings
		{
			get
			{
    ...
    partial void OnActiveChanged();
		...
		[Column(Storage="_StateName", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_StateCode", DbType="VarChar(2) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="State_Tax", Storage="_Taxes", ThisKey="StateID", OtherKey="StateID")]
		public EntitySet<Tax> Taxes
		{
			get
			{
		...
		[Association(Name="State_Customer", Storage="_Customers", ThisKey="StateID", OtherKey="StateID")]
		public EntitySet<Customer> Customers
		{
			get
			{
		...
		[Association(Name="State_Order", Storage="_Orders", ThisKey="StateID", OtherKey="StateID")]
		public EntitySet<Order> Orders
		{
			get
			{
		...
		[Association(Name="State_Shipping", Storage="_Shippings", ThisKey="StateID", OtherKey="StateID")]
		public EntitySet<Shipping> Shippings
		{
			get
			{
