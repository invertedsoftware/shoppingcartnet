...
<asp:Repeater ID="ProductsSummaryRepeater" runat="server" 
    ...
    <ItemTemplate>
    <tr>
        <td><a href="Product.aspx?Product=<%# Eval("ProductName")%>"><%# Eval("ProductName")%></a></td>
    </tr>
    <tr>
        <td><a href="Product.aspx?Product=<%# Eval("ProductName")%>"><img src='ProductImages/<%# Eval("Thumbnail") %>' alt='<%# Eval("ProductName") %>' style="border-style:none" width="75" height="75" /></a></td>
    </tr>
    </ItemTemplate>
    <FooterTemplate>
        </table>
